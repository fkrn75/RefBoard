...
상세 진행은 [체크리스트](체크리스트.md), 전체 기능 명세는 [기능명세서](기능명세서.md)를 참고하세요. 화면별 사용법은 [사용 설명서](app/public/manual.html)(배포본은 `/manual.html`, 앱 내 설정 패널 "일반" 탭에서도 열 수 있습니다)를 확인하세요.
...
app/
  ...
  public/
    ...
    manual.html      사용 설명서(자체완결 HTML, 배포 시 `/manual.html`로 접근 — https://refboard-e0m.pages.dev/manual.html)
  src/
